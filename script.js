...
loco();
// the above code is written because locomotive and scrolltrigger can't work hand to hand so in order to ensure that they work cumulatively this code is a must ...


// the following code is used to play the video via calling the fat arrow function
gsap.to("#page>video",{
    scrollTrigger:{
        trigger:`#page>video`,
        start:`2% top`,
...
// In order to remove the contents of page bottom as we scroll down by making its opacity equal to zero 
gsap.to("#page-bottom",{
    scrollTrigger:{
        trigger:`#page-bottom`,
        start:`5% top`,
...
// This what we have done in order to send text upside of page1 when we scroll down using gsap scrolltrigger
